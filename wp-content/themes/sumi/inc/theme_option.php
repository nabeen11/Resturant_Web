		...
		public static function sanitize( $options ) {
			...
			if ( $options ) {
				...
				if ( ! empty( $options['googleplus'] ) ) {
					$options['googleplus'] = sanitize_text_field( $options['googleplus'] );
				} else {
					unset( $options['googleplus'] ); // Remove from options if empty
				}
				if ( ! empty( $options['pinterest'] ) ) {
					$options['pinterest'] = sanitize_text_field( $options['pinterest'] );
				} else {
					unset( $options['pinterest'] ); // Remove from options if empty
				}
			...
			<div class="wrap">
				...
				<form method="post" action="options.php">
					...
					<table class="form-table wpex-custom-admin-login-table">
                        ...
                        <tr valign="top">
							<th scope="row"><?php esc_html_e( 'Linked-in', 'text-domain' ); ?></th>
							<td>
						...
						<tr valign="top">
							<th scope="row"><?php esc_html_e( 'Googleplus', 'text-domain' ); ?></th>
							<td>
						...
						<tr valign="top">
							<th scope="row"><?php esc_html_e( 'Pinterest', 'text-domain' ); ?></th>
							<td>
